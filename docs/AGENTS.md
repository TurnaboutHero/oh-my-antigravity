...
- **Key Abilities**:
  ...
  - Risk identification
  - Quality assurance
- **When to Use**: Validate complex plans
...
- **Key Abilities**:
  ...
  - Caching strategies
  - Core Web Vitals
- **When to Use**: Performance bottlenecks
...
- **Key Abilities**:
  ...
  - Dependency scanning
- **When to Use**: Security-sensitive features
...
- **When to Use**: Industry best practices
...
#### 28. (Example: Hello Antigravity)
- **Role**: Demo Agent
- **Specialty**: Framework demonstration
- **Model Tier**: Low
- **Key Abilities**:
  - Show skill structure
  - Example usage
  - Testing
- **When to Use**: Learning OMA
...
All agents are available as skills in `~/.gemini/antigravity/skills/`
